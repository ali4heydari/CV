...
\begin{document}
    ...
    \begin{aside}
        ...
        \includegraphics[scale=0.03]{../assets/images/Java_logo.png} \textbf{Java}%\includegraphics[scale=0.33]{../assets/images/2stars.png}

        \includegraphics[scale=0.0047]{../assets/images/Android_logo.png} \textbf{Android}%\includegraphics[scale=0.33]{../assets/images/1stars.png}

        \textbf{\LaTeX}%\includegraphics[scale=0.33]{../assets/images/3stars.png}

        \textbf{C\#}%\includegraphics[scale=0.33]{../assets/images/2stars.png}

        \textbf{C++}%\includegraphics[scale=0.33]{../assets/images/1stars.png}

        \includegraphics[scale=0.0045]{../assets/images/Python_logo.png} \textbf{Python}%\includegraphics[scale=0.33]{../assets/images/1stars.png}

        \includegraphics[scale=0.008]{../assets/images/SQL_logo.png} \textbf{SQL}%\includegraphics[scale=0.33]{../assets/images/1stars.png}
        ...
        Office,
        Photoshop,
        \includegraphics[scale=0.025]{../assets/images/Git_logo.png}\textbf{Git} ,
        \textbf{\LaTeX},
        Unit \\
        Testing,
        \textbf{TDD}
        ...
        %    \textbf{MacOS}\includegraphics[scale=0.33]{../assets/images/1stars.png}
        %    \textbf{Unix}\includegraphics[scale=0.33]{../assets/images/2stars.png}
        ~
        \section{Places Lived}\label{sec:places-lived}
        \includegraphics[scale=0.5]{../assets/images/iran.png}
        ~
        %   \section{Languages}
        % \textbf{Persian}\includegraphics[scale=0.33]{../assets/images/5stars.png}
        % \textbf{English}\includegraphics[scale=0.33]{../assets/images/2stars.png}
        % ~
    \end{aside}
    ~
    ...
    \begin{entrylist}
        ...
        {01/18-Now}
        {    Software developer}
        {\href{http://www.amngostar-co.com/}{\includegraphics[scale=0.04]{../assets/images/AmnGostar_logo.png} AmnGostar Co}}
    ...
    \begin{entrylist}
        ...
        {\href{http://www.iust.ac.ir/}{\includegraphics[scale=0.08]{../assets/images/IUST_logo_color.png}Iran University of Science and Technology}}
        {}

        \entry
        {2016 - 2017}
        {    B.Sc in Chemical Engineering (Unfinished)}
        {\href{http://www.sharif.ir/}{\includegraphics[scale=0.015]{../assets/images/Sharif_logo.png} Sharif University of Technology}}
        {}
    ...
    \begin{entrylist}
        ...
        {\href{http://kharazmi.medu.ir/fa/}{\includegraphics[scale=0.06]{../assets/images/YKharazmi_logo.jpg} Iran Kharazmi Festival}}
        {The first rank in the provincial section and the country's highest rank}

        \entry
        {03/2014}
        {   Invention of \emph{Damaban SAMA}}
        {\href{http://iripo.ssaa.ir/}{\includegraphics[scale=0.06]{../assets/images/Ghovveh_logo.jpg} Iranian Patent Office}}
        {Holds a patent for \\
        invention of \emph{Damaban SAMA}}
    ...
    \begin{entrylist}
        ...
        {\href{http://coursera.org/}{\includegraphics[scale=0.08]{../assets/images/Coursera_logo.jpg} Coursera} - by \href{https://www.ualberta.ca/}{\includegraphics[scale=0.05]{../assets/images/UAlberta_logo.jpg} University of Alberta}}
        {}

        \entry
        {02/2013}
        {Calligraphy \emph{Momtaz} Degree}
        {\href{http://calligraphers.ir/}{\includegraphics[scale=0.15]{../assets/images/Khoshnevisan_logo.png}Iran Calligraphers Association}}
        {}

        \entry
        {02/2014}
        {Invention Authorization for \emph{Damaban SAMA}}
        {\href{http://www.irost.org/}{\includegraphics[scale=0.09]{../assets/images/IROST_logo.jpg} IROST}}
        {}
