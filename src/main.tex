...
\begin{document}
    ...
    \begin{aside}
        ...
        \textbf{\LaTeX}%\includegraphics[scale=0.33]{../assets/images/stars/3stars.png}
        ...
        \includegraphics[scale=0.008]{../assets/images/logos/SQL_logo.png} \textbf{SQL}%\includegraphics[scale=0.33]{../assets/images/stars/1stars.png}
