...
Iran University of Science and Technology.
 ...
 \href{mailto:ali4heydari@gmail.com}{\textbf{ali4heydari@}\\gmail.com}
  ...
  \section{Programming}
   \includegraphics[scale=0.03]{img/Java_logo.png} \textbf{Java}\includegraphics[scale=0.33]{img/2stars.png}
   \includegraphics[scale=0.0047]{img/Android_logo.png} \textbf{Android}\includegraphics[scale=0.33]{img/1stars.png}
   \textbf{\LaTeX}\includegraphics[scale=0.33]{img/3stars.png}
    \textbf{C\#}\includegraphics[scale=0.33]{img/2stars.png}
    \textbf{C++}\includegraphics[scale=0.33]{img/1stars.png}
     \includegraphics[scale=0.0045]{img/Python_logo.png} \textbf{Python}\includegraphics[scale=0.33]{img/1stars.png}
