...
\begin{aside}
  \includegraphics[scale=0.037]{img/Ali_Heydari.jpg}
  \section{Address}
Iran- Tehran- Narmak -
Iran University of Science and Technology.
 ...
 \href{mailto:ali4heydari@gmail.com}{\textbf{ali4heydari@}\\gmail.com}
  ...
  \section{Programming}
   \includegraphics[scale=0.03]{img/Java_logo.png} \textbf{Java}\includegraphics[scale=0.33]{img/3stars.png}
    \textbf{C\#}\includegraphics[scale=0.33]{img/3stars.png}
    \textbf{\LaTeX}\includegraphics[scale=0.33]{img/4stars.png}
    \textbf{C++}\includegraphics[scale=0.33]{img/2stars.png}
    \includegraphics[scale=0.0047]{img/Android_logo.png} \textbf{Android}\includegraphics[scale=0.33]{img/2stars.png}
     \includegraphics[scale=0.0045]{img/Python_logo.png} \textbf{Python}\includegraphics[scale=0.33]{img/2stars.png}
     \includegraphics[scale=0.008]{img/SQL_logo.png} \textbf{SQL}\includegraphics[scale=0.33]{img/1stars.png}
     \textbf{C}\includegraphics[scale=0.33]{img/1stars.png}
    ~
  \section{Skills}
       \smartdiagram[bubble diagram]{
        ...
        Office,
        Photoshop,
        \includegraphics[scale=0.025]{img/Git_logo.png}\textbf{Git} ,
         \textbf{\LaTeX},
          Unit \\
          Testing,
        \textbf{TDD}
 ...
 ~
  \section{OS Preference}
    \textbf{Windows}\includegraphics[scale=0.33]{img/5stars.png}
    \textbf{GNU/Linux}\includegraphics[scale=0.33]{img/3stars.png}
%    \textbf{MacOS}\includegraphics[scale=0.33]{img/1stars.png}
%    \textbf{Unix}\includegraphics[scale=0.33]{img/2stars.png}
    ~
  \section{Places Lived}
    \includegraphics[scale=0.5]{img/iran.png}
    ~
%   \section{Languages}
  % \textbf{Persian}\includegraphics[scale=0.33]{img/5stars.png}
   % \textbf{English}\includegraphics[scale=0.33]{img/2stars.png}
   % ~
\end{aside}
~
\section{Experience}
...
\begin{entrylist}
  \entry
    ...
    {\href{http://www.iust.ac.ir/}{\includegraphics[scale=0.08]{img/IUST_logo_color.png}Iran University of Science and Technology}}
    {}
